      ...
      <el-row>
        <el-col :span="24">
          <div class="grid-content bg-purple-dark">
            <el-button type="primary" @click="add()">新建印章申请</el-button>
          </div>
        </el-col>
      </el-row>
    </div>
        ...
        <el-col :span="24">
          <div class="grid-content bg-purple-dark">
            <el-table
              ...
              style="width: 100%"
            >
              <el-table-column prop="returnPerson" label="归还人">
              </el-table-column>
              ...
              <el-table-column label="操作" width="250px" :align="center">
                <template v-slot="scope">
                  <el-button
                    size="mini"
                    @click="
                      handleEdit(scope.$index, scope.row), (updatedialog = true)
                    "
                    >详细</el-button
                  >
                  <el-button
...
export default {
  ...
  methods: {
    ...
    add() {
      window.location.href = 'sealReturnadd'
    },
    handleEdit(index, row) {
      console.log(index, row)
      this.$router.push({ path: '/sealReturnxiang?id=' + row.sid })
    }
  }
}
</script>
