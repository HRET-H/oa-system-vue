    ...
    >
      ...
      <el-form-item label="适用范围">
        <el-select
          ...
          placeholder="请选择"
        >
          <el-option label="全公司考勤" value="0"></el-option>
          <el-option label="技术部考勤" value="1"></el-option>
          <el-option label="技术部先锋组考勤" value="2"></el-option>
      ...
      <el-form-item label="是否限额">
        <el-checkbox-group v-model="initiateHolidayForm.limitss">
          <el-checkbox label="是" name="holidayVisibe" value="0"></el-checkbox>
          <el-checkbox label="否" name="holidayVisibe" value="1"></el-checkbox>
        </el-checkbox-group>
      </el-form-item>
      <div class="title">
        <h1>使用规则</h1>
